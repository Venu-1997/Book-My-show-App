                    ...
                    <div className="flex h-16 items-center justify-between">
                        <div className="flex items-center">
                            <div className="flex-shrink-0">
                                <Link to='/' ><img className="h-8 w-8" src="https://tailwindui.com/img/logos/mark.svg?color=indigo&shade=500" alt="Your Company" /></Link>
                            </div>
                            <div className="hidden md:block">
                                <div className="ml-10 flex items-baseline space-x-4">
                                    ...
                                    <Link to="/theatres" className="bg-gray-900 text-white rounded-md px-3 py-2 text-sm font-medium" aria-current="page">Shows</Link>
                                </div>
                            </div>
                        </div>
                        <div className="hidden md:block">
